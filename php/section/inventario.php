...
foreach($inventario as $inv) {
    ...
    echo '<input type="text" style="display:none" name="procesar" value="actualizarinventario"/>';
    ...
    echo '</form>';
    echo '<form method="post" action="/procesar/">';
    echo '<input type="text" style="display:none" name="procesar" value="borrarinventario"/>';
    echo '<input type="text" style="display:none" name="id" value="' . htmlentities($inv['id']) .'"/>';
    echo '<input type="text" style="display:none" name="descripcion" value="' . htmlentities($inv['Descripcion']) .'"/>';
    echo '<input type="text" style="display:none" name="tabla" value="inventario"/>';
...
echo 'document.getElementById("nosep-"+i).readOnly = true;';
echo 'document.getElementById("noinventario-"+i).readOnly = true;';
echo 'document.getElementById("descripcion-"+i).readOnly = true;';
echo 'document.getElementById("marca-"+i).readOnly = true;';
echo 'document.getElementById("modelo-"+i).readOnly = true;';
echo 'document.getElementById("serie-"+i).readOnly = true;';
echo 'document.getElementById("valor-"+i).readOnly = true;';
echo 'document.getElementById("fecha-"+i).readOnly = true;';
